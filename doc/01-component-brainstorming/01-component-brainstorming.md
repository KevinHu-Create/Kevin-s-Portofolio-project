...
Talking about my interests, it's mainly on combine computer science technology with some traditional field, in that way we can make our work and life easier so that human beings can be truly work and life balanced, Especially in data handling. In my point of view I think effective data processing technology can not only decrease humans' workload but also could avoid much accidents, for example in many ways from airports' aircraft control system to a restaurant's ordering system, they are all implementations on data processing which are extremely beneficial. So, for my own portofolio project I just want to implement an easy application in daily cases, that is Inventory Management, with this InventoryManager supermarket or restaurant can easily know which items or dishes will be sold out and purchase more before it was sold out. Further more, In the future this project(systems) could even be extended to restore the data which items are most popular and it could even help the user to improve their products through the systems analysis.
